...
% PHIPADE - Evaluate phi functions using diagonal Padé approximations.
%
% SYNOPSIS:
%    phi_k                     = phipade(z, k);
%    phi_k                     = phipade(z, k, d); 
...
%   integrators using diagonal Padé approximants.
...
%   d - Degree of diagonal Padé approximant.  OPTIONAL.
%       Default value: d = 7.
%
% RETURNS:
%    phi_k                     =      \phi_k(z)
...
PADE_DEGR = 7;          % degree of (d,d)-Padé approximant
atol = 1.0e-13;         % FLTEQ absolute error tolerance
rtol = 5.0e-12;         % FLTEQ relative error tolerance
...
[s, z] = scaled_arg(z);
Id = speye(size(z));
[phi_vals{1:k}] = scaled_pade(z, Id, d, k);     % (d,d)-Padé approx
...
% Scaling to obtain well-behaved Padé approximations.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% Internal eval functions implementing Padé algorithm.
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% Padé eval algorithm due to Higham in
...
% Re-normalised (d,d)-Padé coefficients for the \phi_\ell functions.
%
%%%% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %
%
% This code is based on the explicit (d,d)-Padé formulae derived by W.
